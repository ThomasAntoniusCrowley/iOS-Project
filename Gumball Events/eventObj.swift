...
func getVenueInfo()->String
{
  ...
  */
  return "The Venue information: \nID: \(id) \nWeb Address: \(venue_url) \nEvent Address: \(venue_address)"
    ...
    init(eventID: String, URLAddress: String, eventTitle: String,
        eventDescription: String, eventStartTime: String, eventEndTime: String,
      venueID: String, venueURL: String, venueDisplay: String,
    venueAddress: String, cityName: String, regionName: String, regionAbbr: String,
  postCode: String, country: String, allDayFlag: Int, latitude: Float, longitude: Float,
geocodeType: String, trackbackCount: Int, calendarCount: Int, commentCount: Int,
linkCount: Int, creationDate: String, eventOwner: String, modified: String)
  {
    self.id = eventID
    self.url = URLAddress
